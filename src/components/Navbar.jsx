...
const Navbar = ({ activeSection, setActiveSection }) => {
    ...
    return (
        <motion.nav
            ...
            className="h-full flex flex-col justify-center w-full md:w-1/4 relative px-4 md:pl-12"
            style={{ backgroundColor: '#121212' }}
        >
            <div className="z-10 flex flex-col h-full justify-between py-8">
                {menuItems.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-2 md:gap-5" style={{ paddingLeft: '1rem' }}>
                                <Icon
                                    size={24}
                                    className={`md:w-10 md:h-10 ${isActive ? 'text-white' : 'text-gray-500'} group-hover:text-white transition-colors`}
                                />
