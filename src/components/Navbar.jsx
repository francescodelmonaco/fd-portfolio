...
export default function Navbar({ activeSection, setActiveSection }) {
    return (
        ...
        >
            <div className="z-10 flex lg:flex-col w-full h-full items-center self-center justify-between relative  rounded-[50px] p-2 text-white/90 bg-black/20 backdrop-blur-sm transparent-card"
            >
