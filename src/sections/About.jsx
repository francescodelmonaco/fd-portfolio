...
const About = () => {
    return (
        <motion.div
            ...
            className="w-full h-screen flex justify-center items-center px-12 py-16"
        >
            <div className="flex flex-col w-4/5 max-w-5xl text-center gap-7">
                {/* Profile Photo */}
                <motion.div
                ...
                <motion.h1
                    ...
                    className="text-6xl text-gray-900 mb-4"
                >
                    Francesco Delmonaco
                </motion.h1>
                <motion.p
                ...
                <motion.div
                    ...
                    className="flex justify-center space-x-6 gap-10"
                >
                    <a
                        href="https://github.com/francescodelmonaco"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors gap-3"
                    >
                        <Github size={35} />
                        <span>GitHub</span>
                    </a>
