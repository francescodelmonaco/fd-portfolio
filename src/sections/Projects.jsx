            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full sm:w-5/6 md:w-4/5 lg:w-3/4 xl:w-2/3">
                {projects.map((project, idx) => (
                    <motion.div
                        ...
                        className="transparent-card rounded-3xl p-6 flex flex-col justify-between"
                    >
                        <div className='flex flex-col gap-2'>
                            ...
                            <p className="text-gray-400 mb-4 line-clamp-5 lg:line-clamp-2">{project.description}</p>
                        </div>
                        <div className='flex flex-wrap gap-2 align-middle'>
                            {project.tech.map((tech, i) => (
                                <span key={i} className="bg-gray-600 shadow px-2 py-1 rounded-full text-xs font-medium">
                                    {tech}
                                </span>
                            ))}
                        </div>
